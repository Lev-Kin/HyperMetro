...
public abstract class Command {
    ...
    public static Command newCommand(String commandName, Metro metro) {
        return switch (commandName) {
            case "output" -> new OutputCommand(metro);
            case "append" -> new AppendCommand(metro);
            case "add-head" -> new AddHeadCommand(metro);
            case "remove" -> new RemoveCommand(metro);
            case "connect" -> new ConnectCommand(metro);
            case "route" -> new RouteCommand(metro);
            case "fastest-route" -> new FastestRouteCommand(metro);
